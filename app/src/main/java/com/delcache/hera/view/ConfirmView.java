package com.delcache.hera.view;
...
import com.delcache.hera.utils.DensityUtil;
...
public class ConfirmView extends View {
    ...
    private int[] colors = {0xFF0099CC, 0xFF99CC00, 0xFFCC0099, 0xFFCC9900, 0xFFa52a2a, 0xFF00CC99};
    ...
    private AnimationSuccess animationSuccess;
    ...
    public ConfirmView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int width = DensityUtil.dipToPx(context, 5);
        if(width > 20)
            width = 20;
    ...
    public void startPhareAnimation() {
        if (mPhareAnimator == null) {
            ...
            mPhareAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animator) {
                    if (animationSuccess != null) {
                        postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                animationSuccess.animationSuccess(mCurrentState);
...
//        mEndAngleAnimator.start();
    ...
    public void setConfirmSuccess(AnimationSuccess animationSuccess) {
        this.animationSuccess = animationSuccess;
    }

    public interface AnimationSuccess {
        void animationSuccess(State mCurrentState);
    }
}
